Feature: Minha conta
  ...
  Scenario: Alterar senha
    ...
    And apresentar as regras de senha "Máximo de 20 caracteres", "Mínimo de 6 caracteres", "Alfanumérico", "Pelo menos 1 caractere especial (Ex.: @, #, !, $)", "Sem caracteres sequênciais (Ex.:123456ABC)" e "Ambas as senhas devem ser iguais"
